...
router.get("/badleads", lead.getBadleads);
router.get("/badlead/:id", lead.getBadleadById);
router.delete("/deletebadleads",lead.deleteMultipleBadleads);
router.delete("/deletebadleadsbyId",lead.deleteBadLeadsById);
