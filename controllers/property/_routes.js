...
router.post(
  ...
  property.upload.array("file0", 10),
  property.propertyPhoto
);
router.post(
  "/add-virtual-tours-or-videos/:id",
  property.virtualTours.array("file0", 10),
  property.VirtualToursorVideos
);
router.post(
  "/add-floor-plans/:id",
  property.FloorPlansStorage.array("file0", 10),
  property.FloorPlans
);
router.post(
  "/add-property-documents/:id",
  property.PropertyDocumentsStorage.array("file0", 10),
